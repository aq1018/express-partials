...
function lookup(root, view, ext){
  ...
  // Try just giving the user what they passed you first, don't be too tricky.
  var path = ((root.match(/\/$/)) ? root : (root + '/')) + view + ( (view.indexOf(ext) == -1) ? ext : '');
